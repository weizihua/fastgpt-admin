import { Card, Divider, Grid, Link, Space, Typography } from '@arco-design/web-react';
import { IconApps, IconUser, IconUserGroup } from 'tushan/icon';
import React, { useEffect, useState } from 'react';
import { useTranslation } from 'react-i18next';
import { Area, AreaChart, CartesianGrid, ResponsiveContainer, Tooltip, XAxis, YAxis } from 'tushan/chart';
...
export const Dashboard: React.FC = React.memo(() => {
  ...
  useEffect(() => {
    ...
    const fetchCounts = async () => {
      ...
      const modelResponse = await fetch(`${ baseUrl }/apps/count`, {
        headers
      });
